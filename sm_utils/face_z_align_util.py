...
def face_z_transform(positions, global_orient, trans):
    ...
    r_hip, l_hip, sdr_r, sdr_l = joints_name.index('right_hip'), joints_name.index('left_hip'), joints_name.index('right_shoulder'), joints_name.index('left_shoulder')
    ...
    global_orient_matrix = torch.matmul(root_matrix_init, global_orient_matrix.to(root_matrix_init.device))
