...
from .config import HUMAN_MODEL_PATH
...
class MANO(object):
    def __init__(self):
        ...
        self.layer = {'right': smplx.create(HUMAN_MODEL_PATH, 'mano', is_rhand=True, use_pca=False, flat_hand_mean=False, **self.layer_arg),
                      'left': smplx.create(HUMAN_MODEL_PATH, 'mano', is_rhand=False, use_pca=False, flat_hand_mean=False, **self.layer_arg)}
        self.vertex_num = 778
...
class FLAME(object):
    def __init__(self):
        ...
        self.layer = smplx.create(HUMAN_MODEL_PATH, 'flame', use_face_contour=True, **self.layer_arg)
